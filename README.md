...
- GET - получение данных, в самом получении данных ничего сложного. Сложности начались когда нужно было проверить - была ли ли Refresh операция и если да, то вернуть новые токены в ответе. И вообще, вернуть в ответе как отработал Middleware. 
